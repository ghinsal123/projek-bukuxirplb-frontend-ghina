...
//sebuah objek yang dibuat menjadi class

//privat _LoginViewState karena pake underscore maka artinya itu privat
//tipe data future 
...
//komponen widget yang menyusun sebuah ui
  @override
                            ...
                            child: Column(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    obscureText: passwordHidden, //untuk melihat pw
                                    ...
                                    decoration: InputDecoration(
                                        ...
                                        suffixIcon: IconButton(
                                            onPressed: () => {
                                                  setState(() {// untuk merubah kondisi dari 1 siklus hidup yang sedang berjalan, widget dibuat trus dimusnahkan.
                                                    passwordHidden =
                                                        !passwordHidden;//! simbol negasi
                                                  })
                                                },
                                        ...
                                        focusedErrorBorder: OutlineInputBorder(//pesan error saat isi form 
                                            borderRadius:
                                                BorderRadius.circular(20)),
                                        errorBorder: OutlineInputBorder(
                                            borderRadius:
                                ...
                                Padding(
                                  ...
                                  child: MaterialButton(
                                    ...
                                    onPressed: () {//atribut dari MaterialButton
                                      //Validasi form input
                                      if (_formkey.currentState!.validate()) {
                                        isLoading = true;
                                        //aksi login
